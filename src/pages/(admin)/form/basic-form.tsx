...
import { CalendarIcon, Cigarette, CheckIcon } from "lucide-react"
...
export function Component() { 
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    toast.success("You submitted the following values: " + JSON.stringify(values, null, 2))
  }
  return (
    <div className="mx-auto max-w-3xl p-6">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                          ...
                          <FormControl>
                            ...
                            >
                              {field.value ?
                                ...
                                "Select language"}
                              <Cigarette className="ml-2 size-4 shrink-0 opacity-50" />
                            </Button>
                          </FormControl>
                        </PopoverTrigger>
          ...
          <div className="rounded-lg border p-6">
            <h2 className="mb-6 text-lg font-medium">Contact & Notifications</h2>
            <div className="space-y-6">
              <FormField
                control={form.control}
                name="email"
